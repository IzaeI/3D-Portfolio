  ...
  return (
    <section className="max-container">
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>I've embarked on numerous projects throught the years,
        but these are the ones I hold closer to my heart. Many of
        them are open-sourced, so if you come across something that
